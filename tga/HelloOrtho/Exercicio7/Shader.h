...
public:
    ...
    void setFloat(const std::string& name, float first_value,
        float second_value, float third_value) const
    {
        glUniform4f(glGetUniformLocation(ID, name.c_str()), first_value, second_value, third_value, 0.0f);
    }
